...
void loop(){
  ...
  if (start == 2){                                                          //The motors are started.
    ...
    if (esc_1 < 1000) esc_1 = 1050;                                         //Keep the motors running.
    if (esc_2 < 1000) esc_2 = 1050;                                         //Keep the motors running.
    if (esc_3 < 1000) esc_3 = 1050;                                         //Keep the motors running.
    if (esc_4 < 1000) esc_4 = 1050;                                         //Keep the motors running.
